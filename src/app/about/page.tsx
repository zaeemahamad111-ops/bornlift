  ...
  return (
    <main className="pt-32 min-h-screen bg-black">
      <section className="px-8 max-w-6xl mx-auto mb-20">
        <span className="font-label-technical text-zinc-500 tracking-widest uppercase mb-4 block">// OUR STORY</span>
        <h1 className="font-display-hero text-7xl md:text-9xl text-white uppercase italic tracking-tighter mb-12">THE ORIGIN</h1>
            ...
            <div className="pt-8 border-t border-zinc-900">
               <div className="grid grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="font-label-technical text-[10px] text-zinc-500 uppercase tracking-widest mt-2">TECHNICAL WEAVES</p>
                  </div>
                  <div>
                    <span className="text-4xl font-black text-white">10k+</span>
                    <p className="font-label-technical text-[10px] text-zinc-500 uppercase tracking-widest mt-2">TESTING HOURS</p>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="bg-zinc-950 py-32 border-y border-zinc-900">
         <div className="px-8 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="space-y-4">
               ...
               <h3 className="text-white font-headline-md uppercase">PRECISION_GEAR</h3>
               <p className="text-zinc-500 text-sm leading-relaxed">Laser-cut seams and advanced bonding eliminate friction points entirely.</p>
            </div>
            <div className="space-y-4">
               <span className="text-[#C0FF00] material-symbols-outlined text-4xl">biotech</span>
               <h3 className="text-white font-headline-md uppercase">BODY_MAPPING</h3>
               <p className="text-zinc-500 text-sm leading-relaxed">Ventilation zones placed exactly where the body dissipates heat most.</p>
            </div>
            <div className="space-y-4">
               <span className="text-[#C0FF00] material-symbols-outlined text-4xl">eco</span>
               <h3 className="text-white font-headline-md uppercase">SUSTAINABLE_CORE</h3>
