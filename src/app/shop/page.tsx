  ...
  return (
    <main className="pt-24 md:pt-32 min-h-screen bg-black">
      <section className="px-6 md:px-8 max-w-[1600px] mx-auto mb-10 md:mb-16">
        <span className="font-label-technical text-label-technical text-[#C0FF00] uppercase mb-4 block">// BORNLIFT_CATALOG</span>
        <h1 className="font-headline-lg text-4xl md:text-headline-lg uppercase text-white mb-8 md:mb-12 italic">ALL_GEAR</h1>
        
        <div className="flex flex-wrap gap-3 md:gap-4 border-b border-zinc-900 pb-8">
          <Link href="/shop" className="px-4 md:px-6 py-2 border border-[#C0FF00] bg-[#C0FF00] text-black font-label-technical text-xs md:text-sm hover:brightness-110 transition-colors">ALL_GEAR</Link>
